...
[- DEX](#4) <br>
[- Mining Pools](#5) <br>
[- Overseas Projects](#6) <br>
[- Lending&Borrowing](#7) <br>
[- Derivatives](#8) <br>
[- Insurance](#9) <br>
[- Stablecoins](#10) <br>
[- Tools](#11) <br>
...
[- DAO](#17) <br>
[- NFT](#18) <br>
[- Decentralized Shops](#19) <br>
[- Token Platforms](#20) <br>
[- Mini Games](#21) <br>
[- Lectures](#22) <br>
[- Protocols](#23) <br>
[- Exchanges](#24) <br>
...
<h3 id="1">- Guide</h3>
  ...
  |:-:|:-:|:-:|:-:|
  |Official Website|Conflux official website|https://confluxnetwork.org/zh/||
  |Scan|Conflux blockchain explorer|https://confluxscan.io/|https://github.com/Conflux-Chain/conflux-scan|
  |Forum|Conflux community forum|https://forum.conflux.fun/||
  |Portal|ConfluxPortal, plug-in wallet for PC|https://portal.conflux-chain.org/|https://github.com/Conflux-Chain/conflux-portal/releases|
...
<h3 id="2">- Community</h3>
  ...
  |:-:|:-:|:-:|
  |Forum|Conflux Community Forum|https://forum.conflux.fun/|
  |Chinese Blog|Conflux official account on Juejin platform|https://juejin.cn/user/1433418893104455/activities|
  |Blog|Conflux official account on Weibo|https://weibo.com/6866409624/manage|
  |WeChat Official Account|Conflux official account|Conflux中文社区 (ID: Conflux-Chain)|
  |Chinese Community|Join WeChat groups|Send "微信群" ("WeChat group" in Chinese) in the WeChat official account of Conflux, scan the QR code to add the admin Confluxgroup, and send "加群" ("Join groups" in Chinese), then the admin will add you to WeChat groups|
  |Overseas Communities|Conflux official discord community|https://discord.com/invite/aCZkf2C|
  |Twitter|Conflux official Twitter account|https://twitter.com/Conflux_Network|
  |English Blog|Medium|https://confluxnetwork.medium.com/|
  |Telegram|Conflux official Telegram account|https://t.me/Conflux_English|
  |Youtube|Conflux official Youtube account|https://www.youtube.com/channel/UCFSTmjoSU8jn6DE_4V2TIzA|
</details>
<br>
<h3 id="3">- Wallet</h3>
...
<h3 id="4">- DEX</h3>
  ...
  |Item|Introduction|Website|Github/Forum|
  |:-:|:-:|:-:|:-:|
  |MoonDEX|DEX based on BoomFlow and MatchFlow. Tutorial: https://juejin.cn/post/6891963199399133198|https://moondex.io/||
  |MoonSwap|Provide rapid and smooth AMM user experience with 0 gas fee based on asset cross chain protocol ShuttleFlow|https://moonswap.fi/||
</details>
<br>
<h3 id="5">- Mining Pools</h3>
...
<h3 id="24">- Exchanges</h3>
  ...
  |Binance||www.binancezh.co/zh-CN|
  |CITEX|||
